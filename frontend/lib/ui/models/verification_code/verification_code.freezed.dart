...
mixin _$VerificationCode {
  ...
  /// Serializes this VerificationCode to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of VerificationCode
...
class _$VerificationCodeImpl implements _VerificationCode {
  _$VerificationCodeImpl({required this.email, required this.code});
  ...
  @override
  String toString() {
    return 'VerificationCode(email: $email, code: $code)';
  }
...
abstract class _VerificationCode implements VerificationCode {
  factory _VerificationCode(
      {required final String email,
      required final String code}) = _$VerificationCodeImpl;
